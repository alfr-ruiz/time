    ...
    <>
      ...
      <nav className="w-full px-6 py-3 flex items-center justify-between bg-white border-b border-gray-100">
        ...
        <div className="flex items-center space-x-5">
          ...
          {/* Account Icon */}
          <button className="focus:outline-none" aria-label="Account">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
      ...
      >
        ...
        <div className="p-4">
          <ul className="space-y-4 font-['IBM_Plex_Sans']" style={letterSpacingStyle}>
            ...
            <li>
              <Link href="/constellation" className="block px-2 py-2 border-b">
                Constellation
              </Link>
            </li>
            <li>
              <Link href="/seamaster" className="block px-2 py-2 border-b">
                Seamaster
              </Link>
            </li>
            <li>
              <Link href="/speedmaster" className="block px-2 py-2 border-b">
                Speedmaster
              </Link>
            </li>
            <li>
              <Link href="/de-ville" className="block px-2 py-2 border-b">
                De Ville
              </Link>
            </li>
            <li>
              <Link href="/accessories" className="block px-2 py-2 border-b">
                Accessories
              </Link>
            </li>
            <li>
              <Link href="/about" className="block px-2 py-2 border-b">
                About
              </Link>
            </li>
            <li>
              <Link href="/contact" className="block px-2 py-2 border-b">
                Contact
              </Link>
            </li>
          </ul>
